        ...
        <aside className='w-80 space-y-6'>
          ...
          <form className='space-y-6' onSubmit={handleSubmit}>
            ...
            <div className='space-y-4'>
              ...
              <span className='block text-xs text-muted-foreground italic leading-relaxed'>Valores mais altos tendem a deixar o resultado mais criativo e com possível erros</span>
            </div>
